...
<div class="container">
    <div class="row m-2">
                    ...
                    <form id="postForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <div class="col-12 text-right">
                                ...
                                <input type="submit" value="Save" name="btnSave" id="btnSave" class="btn btn-dark">
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="col-md-2">
            ...
            <br>
            <div class="imgPreview" id="postImgContainer"></div>
            <!-- <img src="" id="postImgPreview" alt="Image preview"> -->
        </div>
    </div>
</div>
